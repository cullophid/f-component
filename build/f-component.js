...
var h, ref, registerElement, render,
  slice = [].slice;
...
module.exports = (function(_this) {
  return function(arg) {
    var lifeCycle, name, update, vdom, view;
    name = arg.name, view = arg.view, update = arg.update;
    vdom = null;
    lifeCycle = {
      createdCallback: function() {
        return console.log.apply(console, ['created'].concat(slice.call(args)));
      },
      attachedCallback: function() {
        console.log('attached', this.dataset);
        return vdom = render(view(this.dataset), this);
      },
      detachedCallback: function() {
        return console.log.apply(console, ['detached'].concat(slice.call(args)));
      },
      attributeChangedCallback: function() {
        var args;
        args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
        console.log.apply(console, ['attr'].concat(slice.call(args)));
        console.log('dataset', this.dataset);
        return vdom = render(view(this.dataset), this, merge);
      }
    };
...
},{"./register":3,"preact":1}],3:[function(require,module,exports){
module.exports = (function(_this) {
